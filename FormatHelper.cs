...
namespace ExcelHelpers
{
	public class DateTimeFormatHelper
	{
		...
		static Dictionary<string, string> _formats = new Dictionary<string, string>{
			{"ar-DJ", "d/m/yyyy h:mm"},
			...
			{"zu-ZA", "m/d/yyyy h:mm"},
			{"it-IT", "gg/mm/aaaa hh:mm"},
			{"it-SM", "dd/mm/yyyy hh:mm"},
			{"it-CH", "gg.mm.aaaa hh:mm"},
			...
			{"ru-KZ", "ДД.ММ.ГГГГ ч:мм"},
			{"ru-KG", "dd.mm.yyyy h:mm"},
			{"ru-MD", "dd.mm.yyyy h:mm"},
			{"ru-RU", "ДД.ММ.ГГГГ ч:мм"},
			{"ru-UA", "dd.mm.yyyy hh:mm"},
			{"rwk-TZ", "dd/mm/yyyy h:mm"},
			{"ssy-ER", "dd/mm/yyyy h:mm"},
			{"sah-RU", "ДД.ММ.ГГГГ ч:мм"},
			{"saq-KE", "dd/mm/yyyy h:mm"},
			{"smn-FI", "p.k.vvvv t:mm"},
			{"smj-NO", "dd.mm.åååå tt:mm"},
			{"smj-SE", "ÅÅÅÅ-MM-DD tt:mm"},
			{"se-FI", "p.k.vvvv t:mm"},
			{"se-NO", "åååå-mm-dd tt:mm"},
			{"se-SE", "ÅÅÅÅ-MM-DD tt:mm"},
			{"sms-FI", "p.k.vvvv t:mm"},
			{"sma-NO", "dd.mm.åååå tt:mm"},
			{"sma-SE", "ÅÅÅÅ-MM-DD tt:mm"},
			...
			{"es-ES", "dd/mm/aaaa h:mm"},
			{"es-US", "m/d/yyyy h:mm"},
			{"es-UY", "d/m/yyyy h:mm"},
			{"es-VE", "d/m/yyyy h:mm"},
			{"zgh-Tfng-MA", "d/m/yyyy hh:mm"},
			{"sv-AX", "vvvv-kk-pp tt:mm"},
			{"sv-FI", "pp-kk-vvvv tt:mm"},
			{"sv-SE", "ÅÅÅÅ-MM-DD tt:mm"},
			...
			{"tr-TR", "g.aa.yyyy ss:dd"},
			{"tk-TM", "dd.mm.yy hh:mm"},
			{"uk-UA", "dd.mm.yyyy h:mm"},
			{"hsb-DE", "T.M.JJJJ h:mm"},
			{"ur-IN", "d/m/yy h:mm"},
